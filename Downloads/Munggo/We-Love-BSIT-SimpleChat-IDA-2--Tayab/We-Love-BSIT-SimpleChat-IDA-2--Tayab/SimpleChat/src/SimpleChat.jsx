...
<form onSubmit={handleSubmit} className="flex flex-col w-full max-w-2xl mx-auto mt-10">
  
  {/* CYBER ID BLOCK */}
  <div className="mb-8"> {/* This mb-8 is the "glue remover" */}
    <label className="block text-sm font-bold text-cyan-300 uppercase tracking-[0.3em] mb-3">
      ⚡ CYBER ID
    </label>
    <input
      type="text"
  ...
  {/* CHATROOM BLOCK */}
  <div className="mb-10"> {/* Extra space before the button */}
    <label className="block text-sm font-bold text-cyan-300 uppercase tracking-[0.3em] mb-3">
      🔴 CHATROOM
    </label>
    <input
      ...
      placeholder="BSIT-3A / GROUP-ALPHA /"
      required
      className="cyber-input w-full"
    />
  </div>
  ...
  <div className="flex justify-start">
    <button type="submit" className="btn-red px-10 py-4 font-black transition-transform hover:scale-105">
      🚀 ENTER CYBERSPACE
    </button>
  </div>
</form>
